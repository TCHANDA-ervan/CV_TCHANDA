...
<div id="partie_gauche1" >  
                 ...
                 <img id="im3" src="image/moi.jpg" alt="ma photo">
  ...
  <div class="link-parent">
    <a href='#' class='link-item' id='link-one' title="Envoyer votre CV dans une adresse Mail">
      <i class="material-icons">+</i>
    </a>
    <a class='link-item' id='link-two' title="Enregistrez votre CV en pdf" href="pdf.php?url=pdf/cv.pdf" download >
      <i class="material-icons">+</i>
    </a>
  </div>
</div>
